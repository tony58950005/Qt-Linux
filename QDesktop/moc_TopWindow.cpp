...
const QMetaObject TopWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TopWindow.data,
      qt_meta_data_TopWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TopWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TopWindow.stringdata0))
        return static_cast<void*>(const_cast< TopWindow*>(this));
