...
const int kAIDelay = 999; // AI下棋的思考时间
...
//    centralWidget()->setMouseTracking(true);
    ...
    // 添加菜单
    QMenu *gameMenu = menuBar()->addMenu(tr("游戏菜单")); // menuBar默认是存在的，直接加菜单就可以了
    gameMenu->setStyleSheet("QMenu {font-size:30px}");
//    QAction *actionPVP = new QAction("Person VS Person", this);
    ...
    QAction *actionPVE = new QAction("人机大战", this);
