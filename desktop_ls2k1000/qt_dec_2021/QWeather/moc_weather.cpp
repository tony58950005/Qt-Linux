...
QT_MOC_LITERAL(1, 8, 13), // "weekDataReady"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 24), // "slotFinishedIpQueryReply"
QT_MOC_LITERAL(4, 48, 27) // "slotFinishedWeatherGetReply"

    },
    "Weather\0weekDataReady\0\0slotFinishedIpQueryReply\0"
    "slotFinishedWeatherGetReply"
};
...
void Weather::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->weekDataReady(); break;
        case 1: _t->slotFinishedIpQueryReply(); break;
        case 2: _t->slotFinishedWeatherGetReply(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Weather::weekDataReady)) {
                *result = 0;
                return;
            }
        }
