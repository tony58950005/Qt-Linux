...
//    qDebug <<"wmk:"<< _gps->_gpgga;
//    qDebug <<"wmk:"<< _gps->_gprmc;
//    qDebug <<"wmk:"<< _gps->_gpgsa;
...
Serial *MainWindow::setupSerialPortDialog() {
    ...
    form.addRow(QString("波特率: "), baudRate);
    ...
    form.addRow(QString("字节位长: "), dataBits);
