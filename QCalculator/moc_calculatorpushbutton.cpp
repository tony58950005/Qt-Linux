/****************************************************************************
** Meta object code from reading C++ file 'calculatorpushbutton.h'
**
...
#error "The header file 'calculatorpushbutton.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 21, 13), // "signalClicked"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 6), // "number"
QT_MOC_LITERAL(4, 43, 11) // "slotClicked"

    },
    "CalculatorPushButton\0signalClicked\0\0"
    "number\0slotClicked"
};
...
void CalculatorPushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CalculatorPushButton::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CalculatorPushButton::signalClicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CalculatorPushButton::staticMetaObject = {
...
// SIGNAL 0
void CalculatorPushButton::signalClicked(int _t1)
{
