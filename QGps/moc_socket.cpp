...
QT_MOC_LITERAL(1, 7, 15), // "socketReadyRead"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 10), // "gpsPackage"
QT_MOC_LITERAL(4, 35, 16), // "on_newConnection"
QT_MOC_LITERAL(5, 52, 15), // "on_disconnected"
QT_MOC_LITERAL(6, 68, 12) // "on_readyRead"

    },
    "Socket\0socketReadyRead\0\0gpsPackage\0"
    "on_newConnection\0on_disconnected\0"
    "on_readyRead"
};
...
void Socket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->socketReadyRead((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Socket::*)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Socket::socketReadyRead)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Socket::socketReadyRead(QByteArray _t1)
{
