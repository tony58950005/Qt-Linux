...
QT_MOC_LITERAL(1, 7, 15), // "serialReadyRead"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 10), // "gpsPackage"
QT_MOC_LITERAL(4, 35, 17), // "handleSerialError"
QT_MOC_LITERAL(5, 53, 28), // "QSerialPort::SerialPortError"
QT_MOC_LITERAL(6, 82, 5), // "error"
QT_MOC_LITERAL(7, 88, 10) // "readSerial"

    },
    "Serial\0serialReadyRead\0\0gpsPackage\0"
...
void Serial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->serialReadyRead((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Serial::serialReadyRead)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Serial::serialReadyRead(QByteArray _t1)
{
